...
distance = 0
runs = 0
#name of participant, distance ran by them, and the number of runs
...
def __init__(self, name, distance=0):
 ...
 # addDistance method
        #***this adds the distances of the runner if they're greater than 0
...
for item in rawData:
    ...
    if not item['name'] in participants.keys():
        participants[item['name']] = participants(item['name'])
